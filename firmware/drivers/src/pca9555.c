...
static pca9555_status_t i2c_status_to_pca9555_status(
    i2c_status_t status);

static pca9555_status_t pca9555_write(
    pca9555_device_t const *device,
    pca9555_reg_t           reg,
    uint16_t                        value);
...
pca9555_status_t
pca9555_write_cfgs (pca9555_device_t const *device,
                            pca9555_cfgs_t          cfgs)
{
    ASSERT(device != NULL);
