...
#define SERIAL_READ_BUF_SIZE (512u)
...
typedef enum
{
    ...
    SERIAL_STATUS_ERR,
    SERIAL_STATUS_ERR_DEST_BUFFER_OVERFLOW,
...
typedef struct
{
    char  *str;  /**< String inside the buffer. */
 ...
 */
serial_status_t serial_read_line(serial_buf_t *buf);
