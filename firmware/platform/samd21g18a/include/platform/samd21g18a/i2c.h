...
typedef enum
{
    PLATFORM_SAMD21G18A_I2C_MASTER_SERCOM0 = 0,
...
typedef enum
{
    PLATFORM_SAMD21G18A_I2C_SERCOM_PAD0 = 0,
    PLATFORM_SAMD21G18A_I2C_SERCOM_PAD1,
    PLATFORM_SAMD21G18A_I2C_SERCOM_PAD2,
    PLATFORM_SAMD21G18A_I2C_SERCOM_PAD3,
